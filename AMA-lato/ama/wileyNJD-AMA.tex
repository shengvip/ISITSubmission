...
\usepackage{etex}
\usepackage{bigfoot}
\usepackage{amsmath,amssymb,amstext,amsfonts,amsxtra,amsbsy,latexsym}
\usepackage[amsmath,thmmarks,thref,hyperref]{ntheorem}
% 'standard option' omitted
\AtBeginDocument{\input{standard.std}}
% or \AtBeginDocument{\input{standard.cfg}}
